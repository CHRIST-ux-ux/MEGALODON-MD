...
module.exports = {
    ...
    SESSION_ID: process.env.SESSION_ID || "MEGALODON~MD~YBRmnA4L#TLjyA9bkqsH5m8fYk8-Am6pSzcNeynoD31_vPmIf13U",  // Your bot's session ID (keep it secure)
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "50937722723",  // Owner's WhatsApp number
    
    OWNER_NAME: process.env.OWNER_NAME || getConfig("OWNER_NAME") || "",           // Owner's name
    
    DEV: process.env.DEV || "50937722723",                     // Developer's contact number
